...
# define common used convolutional layers
def conv3x3(in_, out):
    return nn.Conv2d(in_, out, 3, padding=1)

# concatinate tensors to the column direction
def concat(xs):
    return torch.cat(xs, 1)

# inherite Module, conv3x3 + bachnormalization + ReLU
...
# def common used UNetModule, 2 layers of "conv package"
